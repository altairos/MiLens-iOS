...
配套 [architecture-review.md](architecture-review.md)（2026-08-14）。优先级按「阻塞上架 → 一致性 → 债务清理」排序；每项含验收标准，完成后回写 PLAN.md。

---

## P0 — 立即（阻塞全部后续验收）

### P0-1 Mac 编译 + 全量 XCTest（消除 R1）⭐ 第一优先级
