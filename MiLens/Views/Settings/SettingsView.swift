...
struct SettingsView: View {
    ...
    private func settingsContent(_ model: SettingsViewModel) -> some View {
        ...
        // 备份导出/恢复流程 sheet/alert/进度浮层/恢复选择器（拆至 SettingsBackupFlow.swift）
        .modifier(SettingsBackupFlowModifier(
            backupVM: backupVM,
            showRestoreImporter: $showRestoreImporter,
            showBackupModeUpdated: Binding(
            ...
            LedgerSection {
                ...
                Button {
                    ...
                    backupEntryRow(
                        ...
                        subtitle: SettingsBackupCopy.exportSubtitle(isPro: entitlement.isPro, backupVM: backupVM),
